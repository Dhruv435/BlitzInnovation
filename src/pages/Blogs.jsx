...
export default function Blogs({ isTransitioning, onNavigate }) {
  return (
    <motion.section
    ...
    >
      ...
      >
        <h1 className="text-[64px] font-inter font-bold mb-6">Blogs</h1>
        <p className="text-[22px] font-inter text-gray-200 max-w-4xl leading-relaxed mb-8">
          Welcome to the Blogs page. This is where your content will go.
        </p>
